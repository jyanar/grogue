...
func (s *BumpSystem) Update2(e int) {
...
func (s *FOVSystem) Update2(e int) {
	p := s.ecs.positions[e]
	f := s.ecs.fovs[e]
	if f.FOV == nil {
...
func (s *DeathSystem) Update2(e int) {
...
func (s *PerceptionSystem) Update2(e int) {
